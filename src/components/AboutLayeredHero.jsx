...
import aboutImage from '../assets/Expert_vets.avif'; // Using the image found
...
const AboutLayeredHero = () => {
    ...
    const yString = useTransform(scrollYProgress, [0, 1], ["0%", "50%"]); // Returns "0%" to "50%"
    // Since we need to pass a string or number to style.y, but framer-motion handles motion value directly in style.

    // Actually simpler: just map 0-1 to pixels or percentage
        ...
        <section ref={ref} className="layered-hero-section">
            ...
            <div className="layered-hero-image-container" data-aos="zoom-in" data-aos-duration="1000">
                <motion.div style={{ y, height: '120%' }}>
                    {/* Increased height to allow scrolling within container without showing edges if overflow hidden */}
