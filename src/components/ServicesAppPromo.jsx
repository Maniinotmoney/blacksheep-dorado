...
const ServicesAppPromo = () => {
    // Extended Data with Pastel Background Colors
    const cardData = [
        {
            title: "WELLNESS",
                ...
                <div className="promo-header-row" data-aos="fade-up">
                    <div className="promo-header-left">
                        <div>
                            ...
                            <h2 className="promo-h2">DORADO Plans ({cardData.length})</h2>
                        </div>
                    </div>
                </div>
                                ...
                                >
                                    ...
                                    <div className="card-content-overlay">
                                        ...
                                        <div className="card-bottom">
                                            ...
                                            {/* <span className="lesson-meta">{card.meta}</span> */}
                                        </div>
                                    </div>
                                </motion.div>
                            );
