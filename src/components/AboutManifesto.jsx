...
const AboutManifesto = () => {
    ...
    // Parallax for the Bio Images
    // Move them slightly opposite to scroll to create depth
    ...
    return (
        <section ref={sectionRef} className="manifesto-section">
            ...
            <div className="manifesto-container">
                ...
                {/* Image positioned absolute in CSS for desktop, handled relative in mobile */}
                {/* <div className="manifesto-image-wrapper" data-aos="fade-in" data-aos-duration="1000">
                    <img src={aboutImage} alt="Vet Cat Interaction" className="manifesto-img" />
                </div> */}
            ...
            {/* Dr. Perez Bio Section - Refined "Poetry of Process" Layout */}
            <div className="manifesto-bio-wrapper">
                ...
                <div className="bio-content-grid">
                    ...
                    {/* Right Image (using same for now but styled differently or another if available) */}
            ...
            {/* Meet Our Team - Expanding Pill Cards */}
