            ...
            <div className="container">
                ...
                <div className="services-grid">
                    ...
                    <div className="service-card" data-aos="zoom-in" data-aos-delay="200">
                        <div className="service-header">
                            <i className="fa-solid fa-calendar-check service-icon-box"></i>
                            <h3 className="service-title">Technician Appointments</h3>
                        </div>
                        <p className="service-text">
                            Technician appointments provide quick, efficient care for routine needs without a full veterinary exam. These visits are ideal for services such as vaccine boosters, nail trims, sample collections, and follow-up treatments. They offer a convenient option to keep your pet’s care on track while saving time.
                        </p>
                    </div>
